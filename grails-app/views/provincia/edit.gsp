...
<head>
    ...
    <title><g:message code="provincia.edit.label" args="[entityName]" default="Modifica"/></title>
</head>
<body>
...
<div id="edit-provincia" class="content scaffold-edit" role="main">
    <h1><g:message code="provincia.edit.label" args="[entityName]" default="Aggiungi"/></h1>
