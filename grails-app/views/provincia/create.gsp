...
<head>
    ...
    <title><g:message code="provincia.create.label" args="[entityName]" default="Nuovo"/></title>
</head>
<body>
...
<div id="create-provincia" class="content scaffold-create" role="main">
    <h1><g:message code="provincia.create.label" args="[entityName]" default="Nuovo"/></h1>
